...
{
	private static final ResourceLocation texture = new ResourceLocation(ModStrings.MODID + ":" +"textures/blocks/verdantpurifier.png");
	private static final ResourceLocation textureGlow = new ResourceLocation(ModStrings.MODID + ":" +"textures/blocks/verdantpurifierglows.png");
