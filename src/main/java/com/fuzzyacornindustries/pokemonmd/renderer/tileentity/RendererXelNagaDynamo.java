...
{
	private static final ResourceLocation texture = new ResourceLocation(ModStrings.MODID + ":" +"textures/blocks/xelnagadynamo.png");
	private static final ResourceLocation textureGlow = new ResourceLocation(ModStrings.MODID + ":" +"textures/blocks/xelnagadynamoglows.png");
