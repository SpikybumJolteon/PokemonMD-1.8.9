...
public class BlockXelNagaDynamo extends BlockContainer
{
	private static final String blockName = "xelnagadynamo";
	
	public BlockXelNagaDynamo()
	{
		super(Material.rock);
	...
	{
		return new TileEntityXelNagaDynamo();
	}
